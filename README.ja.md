...
80×24 では Activity のプロセス表と TX/RX の概要を表示します。高さが小さい場合は概要とプロセス行を縮め、80×12 でも現在の速度、キャプチャのカバー率、プロセスへの帰属率を表示します。Overview の System サイドバーには 90 列以上が必要です。有効な状態でターミナルを広げると再表示されます。
