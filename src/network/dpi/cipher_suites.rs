...
pub fn is_secure_cipher_suite(code: u16) -> bool {
    match code {
        ...
        0xcca8 | 0xcca9 | 0xccaa => true, // ChaCha20-Poly1305
...
mod tests {
    ...
    fn test_tls13_cipher_suites() {
        assert_eq!(get_cipher_suite_name(0x1301), Some("TLS_AES_128_GCM_SHA256"));
        assert_eq!(get_cipher_suite_name(0x1302), Some("TLS_AES_256_GCM_SHA384"));
        assert_eq!(get_cipher_suite_name(0x1303), Some("TLS_CHACHA20_POLY1305_SHA256"));
    }
